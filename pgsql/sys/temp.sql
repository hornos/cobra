...
--
-- Tue Mar  2 21:57:28 CET 2010
--



-- skel src: ./dbclean.sql
------------------------------------------------------
-- Session                                          --
------------------------------------------------------
...
$$ LANGUAGE plpgsql SECURITY DEFINER;
-- access grants
REVOKE ALL PRIVILEGES ON FUNCTION f_t_sessions_expired( varchar ) FROM PUBLIC;
...
$$ LANGUAGE plpgsql SECURITY DEFINER;
-- access grants
REVOKE ALL PRIVILEGES ON FUNCTION f_t_sessions_write( varchar, int, text ) FROM PUBLIC;
